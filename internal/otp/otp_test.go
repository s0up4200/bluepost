...
func TestExtract(t *testing.T) {
	...
	tests := []struct {
		...
		{"url query code", "Open https://example.com/login?code=123456", ""},
		{"url query otp", "Open https://example.com/login?otp=123456", ""},
		{"url fragment code", "Open https://example.com/login#code=123456", ""},
		{"url without scheme", "Open example.com/login?code=123456", ""},
		{"url with port", "Open example.com:8080/login?code=123456", ""},
		{"url with IP host", "Open 10.0.0.1/login?otp=123456", ""},
		{"custom URI scheme", "Open myapp://callback?code=123456", ""},
		...
		{"strong beats weak", "Your verification code is 123456. Backup code is 654321.", "123456"},
		{"strong beats ambiguous weak", "Verification code 123456. Backup code is 654321 or 777777.", "123456"},
